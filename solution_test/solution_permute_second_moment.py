"""HiF4 permutation: joint second-moment sort.
...
# =============================================================================
# Linear calibration: fixed-alpha joint second-moment sort
# =============================================================================
def hif4_calibration_and_quantize_weight(
    ...
    params, group_loss, _ = _weighted_losses(Wp, a2.index_select(0, perm))
    return {
        "weight_params": params,
        "activation_state": _state(
            perm, "second_moment_sort", alpha, group_loss.sum()
        ),
    }
